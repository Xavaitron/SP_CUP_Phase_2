"""
Process Task 2 - Reverberant Source Separation
Audio-Visual Zooming using DCCRN-Conformer

Usage:
    python process_task2.py --input mixture.wav --angle 90 --output processed_signal.wav

Or as a module:
    from process_task2 import process_audio
...
MODEL_PATH = os.path.join(SCRIPT_DIR, "reverb_Conformer.pth")
...
def process_audio(input_path, target_angle, output_path, model_path=None, device='cpu'):
    ...
    Args:
        ...
        model_path: Path to model checkpoint (default: reverb_Conformer.pth)
        device: 'cpu' or 'cuda'
